              ...
              return (
                <Link
                  ...
                  className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md transition-colors ${
                    isActive(item.href) ? 'bg-anixi-beige text-anixi-green' : 'text-anixi-beige hover:bg-opacity-20 hover:bg-white'
                  }`}
                >
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <span className="text-sm text-anixi-green font-medium truncate mr-4">Welcome back, Dr. {user?.displayName || 'Doctor'}</span>
                <button
                  type="button"
                  ...
                  return (
                    <Link
                      ...
                      className={`group flex items-center px-3 py-2.5 text-sm font-medium rounded-md transition-colors ${
                        isActive(item.href) ? 'bg-anixi-beige text-anixi-green' : 'text-anixi-beige hover:bg-white/10'
                      }`}
                    >
                      <Icon className="mr-3 h-5 w-5" />
                      {item.name}
