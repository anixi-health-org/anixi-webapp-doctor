...
const mainNav: NavItem[] = [
  ...
  { name: 'Professional Profile', href: '/professional-profile', icon: UserCircleIcon },
];
...
function NavLink({
  ...
  return (
    <Link
      ...
      onClick={onNavigate}
      className={clsx(
        'group flex items-center gap-3.5 rounded-xl px-4 py-3 text-[15px] font-medium leading-snug transition-all duration-150',
        active
