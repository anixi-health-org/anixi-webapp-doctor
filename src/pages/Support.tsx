...
export const Support: React.FC = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        'Go to "My Patients" to see all your connected patients. You can view their profiles, medical history, and appointments. Use the search function to quickly find specific patients.',
    },
    {
      question: 'How do I schedule appointments?',
      answer:
        'Navigate to "Appointments" and click "New Appointment". Select a patient, choose a time slot, and add any notes. Patients will receive a notification.',
    },
    {
      question: 'How do I update my professional profile?',
      answer:
        'Go to "Professional Profile" to edit your specialty, license number, office address, and other details. These changes are saved immediately.',
    },
    {
      question: 'Can patients see my public profile?',
      answer:
        'Yes! Your "Public Profile" is visible to all Anixi users. To manage what patients see, go to "Public Profile" and update your information.',
    },
    {
      question: 'How do I share Anixi with colleagues?',
      answer:
        'Use the "Share Anixi" page to get your referral link or send email invitations. You can track how many people you\'ve referred.',
    },
    {
      question: 'How is my data secured?',
      answer:
        'Anixi uses end-to-end encryption and HIPAA-compliant servers. All patient data is encrypted and securely stored in Firebase. We never share your data with third parties.',
    },
  ];
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('📧 Support: Submitting support request...');
      ...
      console.error('❌ Support: Error:', errorMsg);
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-anixi-green mb-4">Support & Help</h1>
        <p className="text-lg text-anixi-green">Find answers to common questions or contact our support team</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
        <a
          href="https://docs.anixi.app"
          target="_blank"
        ...
        <a
          href="mailto:support@anixi.app"
          className="p-6 bg-white rounded-lg shadow hover:shadow-lg transition-shadow border-l-4 border-purple-600"
        >
          <EnvelopeIcon className="h-8 w-8 text-purple-600 mb-2" />
          <h3 className="font-semibold text-gray-900 mb-1">Email Support</h3>
          <p className="text-sm text-gray-600">support@anixi.app</p>
        </a>

        <a
          href="https://status.anixi.app"
          target="_blank"
          rel="noopener noreferrer"
