...
import { listLocalInvoices } from '../services/invoiceService';
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-600 mt-2">Total: {inv.total.toFixed(2)} {inv.lineItems?.[0]?.currency || 'ZAR'}</div>
                  </div>
