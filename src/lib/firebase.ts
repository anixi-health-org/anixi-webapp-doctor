...
const firebaseConfig = {
    apiKey: process.env.REACT_APP_FIREBASE_API_KEY || "AIzaSyCYoYG2JORKHp6Q3F9ougrE5OqUvnquu2o",
    ...
    appId: process.env.REACT_APP_FIREBASE_APP_ID || "1:639305017116:ios:f5a80456365c03d5457cd9"
};
